...
function Initialized()
    ...
    elseif Config.framework == 'vRP' then
        ...
        vRP.prepare("renzu/get_vehicle", "SELECT user_id, vehicle FROM vrp_user_vehicles WHERE plate = @plate")
        vRP.prepare("renzu/get_vehicle2", "SELECT user_id, vehicle FROM vrp_user_vehicles WHERE vehicle_plate = @plate")
	end
end
