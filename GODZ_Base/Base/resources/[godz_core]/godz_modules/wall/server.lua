...
arc = {}
Tunnel.bindInterface("godz_modules_wall", arc)
Proxy.addInterface("godz_modules_wall", arc)
vRP = Proxy.getInterface("vRP")
Config = module("godz_modules", "config_wall")
...
Citizen.CreateThread(function()
    while true do
        ...
        TriggerClientEvent("godz_modules:updatePlayers", -1, players)
        Citizen.Wait(2000)
    end
end)
