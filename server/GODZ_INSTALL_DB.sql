...
-- godz_factions_inventory
CREATE TABLE IF NOT EXISTS `godz_factions_inventory` (
  `chest_key` varchar(64) NOT NULL,
...
-- Seed: Identities (ID 0 & 1)
INSERT IGNORE INTO `godz_user_identities` (`user_id`, `registration`, `phone`, `firstname`, `name`, `age`, `foragido`, `foto`) VALUES (0, '00000000', '000-000', 'NEXUS', 'IA', 100, 0, NULL);
INSERT IGNORE INTO `godz_user_identities` (`user_id`, `registration`, `phone`, `firstname`, `name`, `age`, `foragido`, `foto`) VALUES (1, '00000001', '123-456', 'Bob', 'Godz', 30, 0, NULL);
...
INSERT IGNORE INTO `godz_user_groups` (`user_id`, `group_name`, `group_grade`) VALUES (3, 'admin', 0);
INSERT IGNORE INTO `godz_user_groups` (`user_id`, `group_name`, `group_grade`) VALUES (4, 'admin', 0);
INSERT IGNORE INTO `godz_user_groups` (`user_id`, `group_name`, `group_grade`) VALUES (5, 'mod', 0);
INSERT IGNORE INTO `godz_user_groups` (`user_id`, `group_name`, `group_grade`) VALUES (6, 'mod', 0);

-- Seed: Nexus Skin (vRP:datatable)
-- Model: mp_f_freemode_01 (1885233650) | Components: Space Ranger / Android Platinum
INSERT IGNORE INTO `godz_user_data` (`user_id`, `dkey`, `dvalue`) VALUES (0, 'vRP:datatable', '{"customization":{"modelhash":1885233650,"2":[20,0],"3":[15,0],"4":[121,0],"6":[90,0],"8":[15,0],"11":[306,0]},"groups":{"bot":true},"inventory":{},"weapons":{}}');
