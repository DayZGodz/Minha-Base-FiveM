...
policia_tunnel = Tunnel.getInterface("godz_modules_policia")
-------------------------------------------------------------------------------------------------------------------------
-- TARGET INTEGRATION (POLICE MENU)
-------------------------------------------------------------------------------------------------------------------------
Citizen.CreateThread(function()
    Citizen.Wait(1000)
    if exports['godz_target'] then
        exports['godz_target']:AddTargetPlayer({
            {
                icon = "fas fa-shield-alt",
                label = "Menu Policial",
                action = function(entity)
                    TriggerServerEvent("vrp_policia:openMenu")
                end
            },
            {
                icon = "fas fa-id-card",
                label = "Verificar Ficha",
                action = function(entity)
                    TriggerServerEvent("vrp_policia:verificarFicha")
                end
            },
            {
                ...
                action = function(entity)
                    TriggerServerEvent("vrp_policia:apreenderItens")
                end
            },
            {
