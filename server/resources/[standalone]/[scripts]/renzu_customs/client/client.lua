...
CreateThread(function()
    ...
    if Config.UseCustomEngineUpgrade then
        nextgearhash = GetHashKey("SET_VEHICLE_NEXT_GEAR")
        setcurrentgearhash = GetHashKey("SET_VEHICLE_CURRENT_GEAR")
    ...
    if Config.UseCustomTireUpgrade then
        while true do
            ...
            if vehicle ~= 0 then
                ...
                if customtire[plate] and customtire[plate] ~= 'Default' then
