...
$(document).ready(function() {
    ...
    $('#fechar').click(() => {
        $.post("http://godz_inventory/invClose");
        $('#quantidade').hide();
        $('#cursor').hide();
...
const updateDrag = () => {
    ...
    $('.usar').droppable({
        ...
        drop: function(event, ui) {
            ...
            $('#msgTeste').html('USAR');
            $('#confirm').click(() => {
                $.post("http://godz_inventory/useItem", JSON.stringify({
                    item: itemData.key,
                    type: itemData.type,
    ...
    $('.dropar').droppable({
        ...
        drop: function(event, ui) {
            ...
            $('#placeQt').val(modalQt);
            $('#confirm').click(() => {
                $.post("http://godz_inventory/dropItem", JSON.stringify({
                    item: itemData.key,
                    amount: Number($("#placeQt").val())
                }))
                $('#quantidade').hide();
    ...
    $('.enviar').droppable({
        ...
        drop: function(event, ui) {
            ...
            $('#confirm').click(() => {
                ...
                $.post("http://godz_inventory/sendItem", JSON.stringify({
                    item: itemData.key,
                    amount: Number($("#placeQt").val())
...
const updateMochila = () => {
    $.post("http://godz_inventory/requestMochila", JSON.stringify({}), (data) => {
