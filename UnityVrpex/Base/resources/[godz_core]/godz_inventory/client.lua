...
-----------------------------------------------------------------------------------------------------------------------------------------
cRP = {}
Tunnel.bindInterface("godz_inventory",cRP)
vSERVER = Tunnel.getInterface("godz_inventory")
-----------------------------------------------------------------------------------------------------------------------------------------
-- INVCLOSE
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- CLOSEINVENTORY
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("godz_inventory:Close")
AddEventHandler("godz_inventory:Close",function(	)
	TransitionFromBlurred(1000)
	SetNuiFocus(false,false)
	SetCursorLocation(0.5,0.5)
	TriggerEvent('hudOff',false)
