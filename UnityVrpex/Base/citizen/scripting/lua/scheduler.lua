...
local function FormatStackTrace()
	return Citizen.InvokeNative(0xF2D16D4C & 0xFFFFFFFF, nil, 0, Citizen.ResultAsString())
end

local function ProfilerEnterScope(scopeName)
	return Citizen.InvokeNative(0x2B0B3E60 & 0xFFFFFFFF, scopeName)
end

local function ProfilerExitScope()
	return Citizen.InvokeNative(0x640821B8 & 0xFFFFFFFF)
end
